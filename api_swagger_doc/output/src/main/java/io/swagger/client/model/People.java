...
public class People {
   ...
   * @return id
  **/
  @ApiModelProperty(value = "Unique identifier representing a specific person")
  public String getId() {
    return id;
  }
  ...
  **/
   ...
   * @return gender
  **/
  @ApiModelProperty(value = "Gender of the person")
   ...
   * @return age
  **/
  @ApiModelProperty(value = "Age, if known, of the person")
   ...
   * @return eyeColor
  **/
  @ApiModelProperty(value = "Eye color of the person")
   ...
   * @return hairColor
  **/
  @ApiModelProperty(value = "Hair color of the person")
   ...
   * @return films
  **/
  @ApiModelProperty(value = "Array of films the person appears in")
  ...
  public People species(String species) {
   ...
   * @return species
  **/
  @ApiModelProperty(value = "Species the person belongs to")
   ...
   * @return url
  **/
  @ApiModelProperty(value = "Unique url of the person")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, gender, age, eyeColor, hairColor, films, species, url);
  }
